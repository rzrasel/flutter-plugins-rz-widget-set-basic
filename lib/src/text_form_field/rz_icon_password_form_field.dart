...
class RzIconPasswordFormField extends StatefulWidget {
  ...
  @override
  State<RzIconPasswordFormField> createState() => _RzIconPasswordFormFieldState();
}
...
class _RzIconPasswordFormFieldState extends State<RzIconPasswordFormField> {
  ...
  void _onFocusChange() {
    // rebuild for hideHintOnFocus + floatHintToBorder
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.floatHintToBorder && hasFocus && widget.hintText != null) {
      ...
      // Not focused, show as hint inside
      effectiveLabel = null;
    ...
    // If user provided both hint and label and floatHintToBorder is true, prioritize label
...
/*
RzIconPasswordFormField(
prefixIcon: Icon(Iconsax.search_normal),
hintText: "Search...",
borderRadius: BorderRadius.circular(500),
hideHintOnFocus: false,
showVisibilityToggle: false,
floatHintToBorder: true,
suffixIconData: null,
suffixIcon: null,
),*/
